...
feature "hidden links" do
  ...
  context "regular users" do
    ...
    scenario "Edit ticket link is shown to user with permission" do
      define_permission!(user, "view",          project)
      define_permission!(user, "edit tickets", project)
      visit project_path(project)
      click_link ticket.title
      assert_link_for "Edit Ticket" # Delete ticket was on this page, not edit
    end
    ...
    scenario "Delete ticket link is shown to user with permission" do
      ...
      visit project_path(project)
      click_link ticket.title
      assert_link_for "Delete Ticket" # Delete ticket was on this page, not edit
    end
